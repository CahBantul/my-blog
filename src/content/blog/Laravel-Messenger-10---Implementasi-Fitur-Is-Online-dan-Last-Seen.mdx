---
heroImage: /src/assets/images/Laravel Messenger.png
category: Fullstack
description: >-
...
## Langkah 1: Buat Kolom last\_seen di Tabel users

Pertama, kita akan membuat kolom last\_seen di tabel users untuk menyimpan waktu terakhir pengguna online.

* Buat migrasi baru untuk menambahkan kolom last\_seen:

```shell
php artisan make:migration add_last_seen_at_to_users_table
```

* Edit file migrasi yang baru dibuat di database/migrations/xxxx\_xx\_xx\_xxxxxx\_add\_last\_seen\_at\_to\_users\_table.php :
...
* Update Model User dengan menambahkan last\_seen\_at pada variable fillable dan cast menjadi datetime
...
Buat middleware untuk memperbarui kolom last\_seen setiap kali pengguna melakukan request.
...
* tambahkan middleware user.last\_seen\_at pada routes\web.php
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full lg:w-2/3">
        ...
        <div
          className={`transform transition-transform ${reply ? "translate-y-0" : "translate-y-full"
